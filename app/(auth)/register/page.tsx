            ...
            <div style={{ display: 'flex', borderBottom: '1px solid var(--border-color)', marginBottom: '24px' }}>
              <button
                ...
                style={{
                  ...
                  background: 'none',
                  border: 'none',
                  borderBottom: registerMethod === 'email' ? '2px solid var(--color-accent)' : 'none',
                  color: registerMethod === 'email' ? 'var(--color-accent)' : 'var(--text-secondary)',
                  fontWeight: '600',
                  cursor: 'pointer',
                  fontSize: '14px',
                  fontFamily: 'inherit'
              ...
              <button
                ...
                style={{
                  ...
                  background: 'none',
                  border: 'none',
                  borderBottom: registerMethod === 'phone' ? '2px solid var(--color-accent)' : 'none',
                  color: registerMethod === 'phone' ? 'var(--color-accent)' : 'var(--text-secondary)',
                  fontWeight: '600',
                  cursor: 'pointer',
                  fontSize: '14px',
                  fontFamily: 'inherit'
